...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "Project costs vary widely based on requirements. Simple websites start around $500, while complex platforms can range from $1,000 to $2,000+. We provide detailed quotes after our discovery process.",
  },
  {
    id: 5,
    ...
    <section id="faq" className="my-20">
      <div className="card p-8 md:p-10 shadow-lg">
        ...
        <p className="mb-8 max-w-2xl text-gray-700 dark:text-gray-300">
          Have questions about our services? Find answers to the most common questions and learn how I can
